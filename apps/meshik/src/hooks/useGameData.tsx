...
import { ABI, CONTRACT_ADDRESS } from '@/utils/consts_meshi';
...
const aMonthFromNowTimestampSeconds =
  ...
  export const join = (seed: number, deck: Card[]) => {
    ...
    const calls =
    contract
      ? [contract.populate("join", [seed, deck])]
      : undefined;
